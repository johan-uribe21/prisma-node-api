...
export type gigsGetPayload<
  S extends boolean | null | undefined | gigsArgs,
  U = keyof S
> = S extends true
  ? gigs
  : S extends undefined
  ? never
  : S extends gigsArgs | FindManygigsArgs
  ? 'include' extends U
    ? gigs 
  : 'select' extends U
    ? {
      [P in TrueKeys<S['select']>]:P extends keyof gigs ? gigs[P]
: 
 never
    }
  : gigs
...
export interface gigsDelegate {
  /**
   * Find zero or one Gigs.
   * @param {FindOnegigsArgs} args - Arguments to find a Gigs
   * @example
   * // Get one Gigs
   * const gigs = await prisma.gigs.findOne({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  **/
  findOne<T extends FindOnegigsArgs>(
    args: Subset<T, FindOnegigsArgs>
  ): CheckSelect<T, Prisma__gigsClient<gigs | null>, Prisma__gigsClient<gigsGetPayload<T> | null>>
  /**
   * Find zero or more Gigs.
   * @param {FindManygigsArgs=} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all Gigs
   * const gigs = await prisma.gigs.findMany()
   * 
   ...
   * 
  **/
  findMany<T extends FindManygigsArgs>(
    args?: Subset<T, FindManygigsArgs>
  ): CheckSelect<T, Promise<Array<gigs>>, Promise<Array<gigsGetPayload<T>>>>
  /**
   * Create a Gigs.
   ...
   * 
  **/
  create<T extends gigsCreateArgs>(
    args: Subset<T, gigsCreateArgs>
  ): CheckSelect<T, Prisma__gigsClient<gigs>, Prisma__gigsClient<gigsGetPayload<T>>>
  /**
   * Delete a Gigs.
   ...
   * 
  **/
  delete<T extends gigsDeleteArgs>(
    args: Subset<T, gigsDeleteArgs>
  ): CheckSelect<T, Prisma__gigsClient<gigs>, Prisma__gigsClient<gigsGetPayload<T>>>
  /**
   * Update one Gigs.
   ...
   * 
  **/
  update<T extends gigsUpdateArgs>(
    args: Subset<T, gigsUpdateArgs>
  ): CheckSelect<T, Prisma__gigsClient<gigs>, Prisma__gigsClient<gigsGetPayload<T>>>
  /**
   ...
   * 
  **/
  deleteMany<T extends gigsDeleteManyArgs>(
    args: Subset<T, gigsDeleteManyArgs>
   ...
   * 
  **/
  updateMany<T extends gigsUpdateManyArgs>(
    args: Subset<T, gigsUpdateManyArgs>
  ): Promise<BatchPayload>
  /**
   ...
   * })
  **/
  upsert<T extends gigsUpsertArgs>(
    args: Subset<T, gigsUpsertArgs>
  ): CheckSelect<T, Prisma__gigsClient<gigs>, Prisma__gigsClient<gigsGetPayload<T>>>
  /**
   * Count
   */
  count(args?: Omit<FindManygigsArgs, 'select' | 'include'>): Promise<number>
 ...
 */
export declare class Prisma__gigsClient<T> implements Promise<T> {
 ...
 * gigs findOne
 */
export type FindOnegigsArgs = {
  /**
   * Select specific fields to fetch from the gigs
  **/
  select?: gigsSelect | null
  /**
...
export type FindManygigsArgs = {
  ...
  **/
  ...
  /**
   * Determine the order of the gigs to fetch.
  **/
  orderBy?: gigsOrderByInput
  /**
   * Sets the position for listing gigs.
  **/
  cursor?: gigsWhereUniqueInput
  /**
   * The number of gigs to fetch. If negative number, it will take gigs before the `cursor`.
  **/
  take?: number
  /**
 ...
 * gigs updateMany
 */
export type gigsUpdateManyArgs = {
  data: gigsUpdateManyMutationInput
  where?: gigsWhereInput
}
 ...
 * gigs deleteMany
 */
export type gigsDeleteManyArgs = {
  where?: gigsWhereInput
}
...
export type gigsOrderByInput = {
  id?: OrderByArg | null
  title?: OrderByArg | null
  technologies?: OrderByArg | null
  budget?: OrderByArg | null
  description?: OrderByArg | null
  contact_email?: OrderByArg | null
